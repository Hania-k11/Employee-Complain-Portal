...
public class Salary_Complain extends Complain {
   
    String description,ComplainName,des_type;
Employee e = new Employee();
    ...
    public Salary_Complain() {
    }

    public Salary_Complain(String description, String ComplainName, String des_type, String time, String date, String type, String status, String remarks) {
