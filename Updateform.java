...
public class Updateform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Enter any information you want to update");
...
dispose();
    ...
    private void submitbt1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitbt1ActionPerformed
     if(text1.getText().length()<= 0 ||text2.getText().length()<= 0||text3.getText().length()<= 0||text3.getText().length()<= 0 || text4.getText().length()<= 0||text5.getText().length()<= 0 ||text6.getText().length()<= 0||text7.getText().length()<= 0||branch.getSelectedItem()=="Choose Branch"||designation.getSelectedItem()=="Choose your Designation")
    {
     ...
     cmp.updateComplain(employeeDataManagement.id);
     emp.updateEmp(employeeDataManagement.id);
     dep.updateComplain(employeeDataManagement.id);
