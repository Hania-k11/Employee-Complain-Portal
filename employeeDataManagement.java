...
public class employeeDataManagement extends javax.swing.JFrame {
    admindispaly ad = new admindispaly();
 ...
 ConnectionToDB con = new ConnectionToDB();
    ...
    ResultSet res=null;
static int id;
         DisplayEmpdetails dis = new DisplayEmpdetails();

    /**
     * Creates new form employeeDataManagement
     */
    ...
    private void initComponents() {
        ...
        update3 = new com.k33ptoo.components.KButton();
        ...
        jLabel2.setText("you want to View,Delete or Update");
        ...
        update3.setkBorderRadius(50);
        update3.setkEndColor(new java.awt.Color(2, 149, 250));
        update3.setkHoverEndColor(new java.awt.Color(234, 93, 1));
        update3.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        update3.setkHoverStartColor(new java.awt.Color(234, 93, 1));
        update3.setkIndicatorThickness(10);
        ...
        addemp.setkBorderRadius(50);
        addemp.setkEndColor(new java.awt.Color(2, 149, 250));
        addemp.setkHoverEndColor(new java.awt.Color(234, 93, 1));
        addemp.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        addemp.setkHoverStartColor(new java.awt.Color(234, 93, 1));
        addemp.setkIndicatorThickness(10);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(view1, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(32, 32, 32)
                        .addComponent(update3, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(37, 37, 37)
                        .addComponent(delete2, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(view1, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(update3, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(delete2, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(91, 91, 91)
...
boolean b4 =false;
        ...
        id = Integer.parseInt(label.getText());
          b1 = emp.deleteEmp(id);
       b2 = cmp.deleteComp(id);
        b3 =dep.deleteDept(id);
       b4 = u.deleteUsername(id);
...
if(b1 == true||b2 == true||b3 == true||b4 == true )
{
   ...
   boolean b1 =false;
        ...
        DisplayEmpdetails dep = new DisplayEmpdetails();
  id = Integer.parseInt(label.getText());
  b1 =emp.searchempppp(id);
  if(b1 == true)
  dep.setVisible(true);
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(employeeDataManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new employeeDataManagement().setVisible(true);
            }
        });
    }
    ...
    private com.k33ptoo.components.KButton update3;
