 ...
 * @author hp
 */
public class complain_status extends javax.swing.JFrame {

    /**
     * Creates new form complain_status
     */
 ...
 Behavioural_Complain beh = new Behavioural_Complain();
        beh.searchComplain(statuscheckform.id);
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        statuscheckform emp = new statuscheckform();
        emp.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(complain_status.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new complain_status().setVisible(true);
            }
        });
    }
