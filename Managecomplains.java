...
public class Managecomplains extends javax.swing.JFrame {
...
boolean b = false;
        ...
        Behavioural_Complain beh = new Behavioural_Complain();
b = cmp.deleteComplain(Integer.parseInt(id));
if(b == true) 
{
    ...
    private void view1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view1ActionPerformed
        ...
        if(label.getText().length()<=0){
           JOptionPane.showMessageDialog(null,"please enter complain ID");
                ...
                id=label.getText();
                b1  = beh.searchComplain(Integer.parseInt(id));
if(b1 == true)
{
DisplayComplains dis = new DisplayComplains();
dis.setVisible(true);
dispose();
    }
else
    ...
    private void update2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update2ActionPerformed
        ...
        if(label.getText().length()<=0){
           JOptionPane.showMessageDialog(null,"please enter complain ID");
                ...
                if(b1 == true)
                {
        UpdateComplainStatus up = new UpdateComplainStatus();
up.setVisible(true);
dispose();
                }
                else
...
dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Managecomplains.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Managecomplains().setVisible(true);
            }
        });
    }
